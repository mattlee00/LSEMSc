...
setwd("/Users/matthewlee/Desktop/RUPS_Dis/1990_Images/DC")
...
folder_path <- "/Users/matthewlee/Desktop/RUPS_Dis/1990_Images/DC"
...
writeLines(all_text, con = "DC1990_compiled_addresses.txt")

# Print confirmation
cat("Data saved to DC1990compiled_addresses.txt\n")

# Define the file path
file_path <- "/Users/matthewlee/Desktop/RUPS_Dis/1990_Images/DC/DC1990_compiled_addresses.txt"
...
address_df$City[address_df$City == "NA" | address_df$City == "" | is.na(address_df$City)] <- "Washington"
...
output_path <- "/Users/matthewlee/Desktop/RUPS_Dis/1990_Images/DC/DC1990_compiled_addresses.csv"
...
setwd("/Users/matthewlee/Desktop/RUPS_Dis/2000_Images/DC")
...
# Path to your folder containing PNG files
folder_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2000_Images/DC"
...
# Write the combined text to a TXT file
writeLines(all_text, con = "DC2000_compiled_addresses.txt")

# Print confirmation
cat("Data saved to DC2000compiled_addresses.txt\n")

# Define the file path
file_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2000_Images/DC/DC2000_compiled_addresses.txt"
...
# Write the data frame to a CSV file
output_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2000_Images/DC/DC2000_compiled_addresses.csv"
write.csv(address_df, output_path, row.names = FALSE)
...
setwd("/Users/matthewlee/Desktop/RUPS_Dis/2010_Images/DC")
...
# Path to your folder containing PNG files
folder_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2010_Images/DC"
...
# Write the combined text to a TXT file
writeLines(all_text, con = "DC2010_compiled_addresses.txt")

# Print confirmation
cat("Data saved to DC2010compiled_addresses.txt\n")

# Define the file path
file_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2010_Images/DC/DC2010_compiled_addresses.txt"
...
# Write the data frame to a CSV file
output_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2010_Images/DC/DC2010_compiled_addresses.csv"
write.csv(address_df, output_path, row.names = FALSE)
...
file_path <- "/Users/matthewlee/Desktop/RUPS_Dis/1990_Images/DC/DC1990_compiled_addresses_cleaned.csv"
...
shapefile_path <- "/Users/matthewlee/Desktop/RUPS_Dis/1990_Images/DC/DC_1990_Geocodes.shp"
...
# Define file path and read CSV
file_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2000_Images/DC/DC2000_compiled_addresses_cleaned.csv"
data <- read_csv(file_path)
...
# Define the shapefile path
shapefile_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2000_Images/DC/DC_2000_Geocodes.shp"
...
# Define file path and read CSV
file_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2010_Images/DC/DC2010_compiled_addresses_cleaned.csv"
data <- read_csv(file_path)
...
# Define the shapefile path
shapefile_path <- "/Users/matthewlee/Desktop/RUPS_Dis/2010_Images/DC/DC_2010_Geocodes.shp"
